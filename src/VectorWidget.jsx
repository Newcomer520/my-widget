    ...
    return (
      <Group
        ...
        <Group x={10} y={10}>          
          ...
          <Shape fill={new LinearGradient(lg.stops, lg.x1, lg.y1, lg.x2, lg.y2)} d={BG_PATH} stroke="#D97B76"/>
          ...
          <Group x={55} y={29} onClick={this.handleALert}>
            <Group rotation={rotation} originX={84} originY={89}>
              <Shape  d={CENTER_DOT_PATH} />
              <Group>
                <Shape d={RING_ONE_PATH} stroke="#FFFFFF" strokeWidth={8} fill="#FFFFFF" />
